...
<head>
    ...
    <title>@lang('messages.AppHeadline') - @lang('messages.AthleteResetHeadline')</title>
    <!-- Bootstrap core CSS -->
...
<body>
    <div id="login-page">
        <div class="container">
            <form class="form-login" action="{{ route('password.request') }}" method="POST">
                @csrf
                <h2 class="form-login-heading">@lang('messages.AthleteResetHeadline')</h2>
                <div class="login-wrap">
                    ...
                    <button id="reset-submit" class="btn btn-login btn-block" type="submit"></i> @lang('messages.Reset')</button>
