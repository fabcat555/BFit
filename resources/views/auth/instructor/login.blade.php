...
<head>
    ...
    <title>@lang('messages.AppHeadline') - @lang('messages.InstructorLogin')</title>
    <!-- Bootstrap core CSS -->
...
<body>
    <div id="login-page">
        <div class="container">
            <form class="form-login" action="{{ route('instructor.login.submit') }}" method="POST">
                @csrf
            ...
            <div class="login-social-link centered">
                <p>@lang('messages.InstructorAlternativeLoginHeadline')</p>
                <a href="{{route('login')}}" class="btn btn-facebook" type="submit">@lang('messages.AthleteLogin')</a>
