            ...
            <div class="col-lg-12">
                <div class="content-panel">
                    ...
                    <div class="edit-btns">
                        ...
                        <a href="{{ route('workout-types.edit', $workoutType->id) }}" class="btn btn-warning btn-sm pull-right">
    ...
    $(document).ready(function() {
        ...
        $('#modal-confirm').on('click', function(e) {
            $.ajax({
                ...
                url: "/workout-types/" + "{{$workoutType->id}}",
                success: function() {
                    window.location.replace('/workout-types');
                }
            });
        });   
});
